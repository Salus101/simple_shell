 ...
 * @str: String to be stored in the new node's str field.
 * @num: Node index used for history.
 *
 * Return: The size of the list after adding the new node.
 */
...
/**
 * free_list - Frees all the nodes of the linked list.
